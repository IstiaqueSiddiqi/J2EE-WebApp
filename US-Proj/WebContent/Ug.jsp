...
<div class="left">
<font color="#339933;" size="5px">Undergraduate Courses</font><br/><br/><br/>
<table width="90%" border="1" align="center" cellspacing="0" cellpadding="3">
  ...
  <%!Connection con = DBCon.getCon();
   String msg="";%>
	...
	{
		PreparedStatement ps=con.prepareStatement("SELECT COURSE_TITLE, COURSE_TYPE, DURATION FROM COURSE WHERE COURSE_TYPE='UG'");//creating preparedstatement object
