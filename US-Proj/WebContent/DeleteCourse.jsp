...
<%!Connection con = DBCon.getCon();
   String msg="";%>
    ...
    <tr>
     <th height="63" colspan="2" scope="row">Delete Course</th>
     <td><input type="hidden" id="pageName" name="pageName" value="DeleteCourse"/></td>
  	 </tr>
	<tr>
    ...
    <form name="del" action="CourseDelete" method="post">
    <table width="34%" align="center">
    <tr>
    <th scope="row"><div align="left">Course Name</div></th>
    <td>
    <input type="hidden" name="course_id" id="course_id" value="${sessionScope.course_id}"/>
    <input type="text" name="course_title" id="course_title" value="${sessionScope.course_title}" readonly/>
    </td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Course Type</div></th>
    <td><input type="text" name="course_type" id="course_type"  value="${sessionScope.course_type}" readonly/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Duration</div></th>
    <td><input type="text" name="duration" id="duration" value="${sessionScope.duration}" readonly/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Exam Type</div></th>
    <td><input type="text" name="exam_type" id="exam_type" value="${sessionScope.exam_type}" readonly/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Description</div></th>
    <td><textarea name="description" id="description" readonly>${sessionScope.description}</textarea></td>
    </tr>
    <tr>
