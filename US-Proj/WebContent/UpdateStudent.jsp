...
<%!Connection con = DBCon.getCon();
   String msg="";%>
    ...
    <tr>
     <th height="63" colspan="2" scope="row">Update Student Details</th>
     <td><input type="hidden" id="pageName" name="pageName" value="UpdateStudent"/></td>
  	 </tr>
	<tr>
    ...
    <td><input type="text" name="sname" id="sname"  value="${sessionScope.sname}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Gender</div></th>
    <td><input type="text" name="gender" id="gender"  value="${sessionScope.gender}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Date of Birth</div></th>
    <td><input type="text" name="dob" id="dob"  value="${sessionScope.dob}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Father's Name</div></th>
    <td><input type="text" name="fname" id="fname"  value="${sessionScope.fname}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Mother's Name</div></th>
    <td><input type="text" name="mname" id="mname"  value="${sessionScope.mname}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Category</div></th>
    <td><input type="text" name="category" id="category"  value="${sessionScope.category}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Religion</div></th>
    <td><input type="text" name="religion" id="religion"  value="${sessionScope.religion}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Nationality</div></th>
    <td><input type="text" name="nationality" id="nationality"  value="${sessionScope.nationality}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Address</div></th>
    <td><input type="text" name="address" id="address"  value="${sessionScope.address}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Mobile No</div></th>
    <td><input type="text" name="mobileNo" id="mobileNo"  value="${sessionScope.mobileNo}"/></td>
    </tr>
    <tr>
    ...
    <td><input type="text" name="status" id="status"  value="${sessionScope.status}"/></td>
    </tr>
    <tr>
    <th scope="row"><div align="left">Verification</div></th>
    <td><input type="text" name="verification" id="verification" value="${sessionScope.verification}" /></td>
    </tr>
    <tr>
