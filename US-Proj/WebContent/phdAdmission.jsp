...
<div class="left">
<font color="#339933;" size="5px">Ph.D Programs</font><br/><br/>
...
<table width="90%" border="1" align="center" cellspacing="0" cellpadding="3">
  ...
  <%!Connection con = DBCon.getCon();
   String msg="";%>
	...
	{
		PreparedStatement ps=con.prepareStatement("SELECT COURSE_TITLE, COURSE_TYPE, DURATION FROM COURSE WHERE COURSE_TYPE='Ph.D'");//creating preparedstatement object
  ...
  <tr height="40">
  	...
  	<td align="center">AURET / NET / GATE / SET / SLET / UGC (JRF) / CSIR (JRF)<br/> FOLLOWED BY AN INTERVIEW</td>
  </tr><%}} %>
</table>
</div>
<br/><br/><br/><br/>
<strong class="fontStyle">Download: </strong><a href="PhDMatter_Spring_2013-14.pdf" target="_blank" class="linkStyle">AURET-Information Brouchure</a>
