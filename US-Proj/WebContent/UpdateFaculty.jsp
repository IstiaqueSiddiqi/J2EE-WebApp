...
<%!Connection con = DBCon.getCon();
   String msg="";%>
    ...
    <tr>
     <th height="63" colspan="2" scope="row">Update Faculty Details</th>
     <td><input type="hidden" id="pageName" name="pageName" value="UpdateFaculty"/></td>
  	 </tr>
	<tr>
    ...
    <form name="update" action="UpdateFaculty" method="post">
    <table width="34%" align="center">
    <tr>
