...
<%!Connection con = DBCon.getCon();
   String msg="";%>
    ...
    <tr>
     <th height="63" colspan="2" scope="row">Update News</th>
     <td><input type="hidden" id="pageName" name="pageName" value="UpdateAnnouncement"/></td>
  	 </tr>
	<tr>
    ...
    <form name="update" action="UpdateNews" method="post">
    <table width="34%" align="center">
    <tr>
    <th scope="row"><div align="left">Description</div></th>
    <td>
    <input type="hidden" name="news_id" id="news_id" value="${sessionScope.news_id}" />
    <textarea name="description" id="description">${sessionScope.description}</textarea>
    </td>
    </tr>
    <tr>
