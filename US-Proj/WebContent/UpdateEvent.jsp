...
<%!Connection con = DBCon.getCon();
   String msg="";%>
    ...
    <tr>
     <th height="63" colspan="2" scope="row">Update Event</th>
     <td><input type="hidden" id="pageName" name="pageName" value="UpdateEvent"/></td>
  	 </tr>
	<tr>
    ...
    <form name="update" action="EventUpdate" method="post">
    <table width="34%" align="center">
    <tr>
  ...
  <tr>
    ...
    <td><textarea name="description">${sessionScope.description}</textarea></td>
  </tr>
  <tr>
    <th scope="row"><div align="left">Venue</div></th>
    <td><textarea name="venue">${sessionScope.venue}</textarea></td>
  </tr>
  <tr>
